...
const page = () => {
  return (
    <div className=' bg-fuchsia-200 flex'>
      ...
      <div className='h-[100vh] w-1/2 flex flex-col justify-center align-center p-5 '>
        ...
        <p className='font-bold text-lg'>You can reach us at <span className='underline text-shadow-blue-600'>developeranubhavdixit99@gmail.com</span></p>
      </div>
    </div>
  )
}
